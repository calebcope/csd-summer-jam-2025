...
public static class WallTypesHelper
{
    ...
    public static HashSet<int> wallTopCornerRight = new HashSet<int>
    {
        0b0110
    };

    public static HashSet<int> wallTopCornerLeft = new HashSet<int>
    {
        0b0011
    };

    public static HashSet<int> wallTopCornerFull = new HashSet<int>
    {
        0b0111
    };
